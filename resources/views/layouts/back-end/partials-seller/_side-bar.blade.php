            ...
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="nav-item {{ Request::is('seller/employees*') ? 'scroll-here active' : '' }}">
                            <small class="nav-subtitle">{{ translate('employee_management') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>

                            @if(auth('seller')->check())
                                <div class="navbar-vertical-aside-has-menu {{ (Request::is('seller/employee*') || Request::is('seller/custom-role*')) ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        style="display: {{ (Request::is('seller/employee*') || Request::is('seller/custom-role*')) ? 'block' : 'none' }}">
                                        
                                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/custom-role*') ? 'active' : '' }}">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            href="{{ route('seller.custom-role.create') }}"
                                        ...
                                        <li class="nav-item {{ (Request::is('seller/employee/'.Employee::LIST[URI]) || Request::is('seller/employee/'.Employee::ADD[URI]) || Request::is('seller/employee/'.Employee::UPDATE[URI].'*')) ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('seller.employee.list') }}"
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('vendor/delivery-man*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('vendor/delivery-man/emergency-contact/*') ? 'active' : ''}}">
                                        ...
                                        title="{{translate('withdraws')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate text-capitalize">{{translate('emergency_contact')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
